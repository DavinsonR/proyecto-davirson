...
export const dictionaries = {
  ...
  es: {
      ...
      also: {
        ...
        rows: [
          ...
          },
          {
            ...
            note: "Diecinueve fuentes públicas (2005–2026) en un warehouse dimensional con dbt y DuckDB, resueltas a código municipal DIVIPOLA. Encima: un índice de inclusión financiera por dimensiones, paneles anuales departamental y municipal, y un atlas. Nace de mi trabajo de grado y lo rehace desde las fuentes.",
    ...
    thesis: {
      ...
      metaDesc: "Diecinueve fuentes públicas colombianas (2005–2026) en un warehouse dimensional con dbt y DuckDB, un índice de inclusión financiera por dimensiones y paneles anuales departamental y municipal.",
      kicker: "Investigación · datos abiertos",
      pill: "EN CONSTRUCCIÓN",
      title: "Inclusión financiera y crecimiento regional en Colombia",
      subtitle: "Un warehouse abierto de fuentes públicas, un índice por dimensiones y dos paneles anuales. Nace de mi trabajo de grado en la Javeriana y rehace todo desde las fuentes.",
      degree: "Origen: Maestría en Economía · Pontificia Universidad Javeriana",
      timeline: "Fases 0 y 1 en el repositorio · el índice y las estimaciones llegan en las fases 2 y 3",
      figures: [
        { value: "19", label: "fuentes públicas con manifiesto y sha256", note: "Superintendencia Financiera, DANE, MinTIC, MEN, MGN", href: `${THESIS_REPO}#data` },
        { value: "2005–2026", label: "de cobertura tras reconstruir las series", note: "PIB desde 2005; inclusión financiera desde 2017", href: `${THESIS_REPO}#data` },
        { value: "1.121", label: "municipios con clave DIVIPOLA resuelta", note: "cobertura del 100 % en los 34 cortes trimestrales", href: `${THESIS_SITE}/datos/crosswalk.html` },
        { value: "6,9 M", label: "filas descargadas y versionadas", note: "particionadas por año en Parquet", href: `${THESIS_SITE}/datos/fuentes.html` },
      ] as Metric[],
      abstract: {
        label: "Resumen",
        body: "¿La inclusión financiera predice el crecimiento económico de los departamentos y municipios colombianos una vez descontadas las tendencias nacionales que los mueven a todos a la vez? Mi trabajo de grado hizo esa pregunta con un panel departamental de cuatro años. Este proyecto la rehace entera: descarga las diecinueve fuentes públicas con un manifiesto verificable, resuelve cada serie al código municipal DIVIPOLA, las modela en un esquema estrella con vintages sobre dbt y DuckDB, y construye un índice de inclusión financiera en dos etapas con pesos congelados y publicados por variable. Encima van dos paneles anuales, departamental y municipal, con una batería explícita contra la correlación espuria. Los resultados se publican cuando existan, con el código que los produjo.",
      },
      method: {
        label: "Cómo está hecho",
        title: "Primero los datos, después el índice, al final la estimación",
        items: [
          { title: "Adquisición con manifiesto", body: "Un descargador propio pagina las API de datos abiertos, verifica el conteo contra la fuente, tipa cada columna con los metadatos del portal y guarda Parquet particionado por año. Cada descarga deja fecha de la fuente, filas y sha256 en un manifiesto que el sitio publica." },
          { title: "Claves geográficas resueltas", body: "Las tablas de la Superintendencia no declaran el código DIVIPOLA, pero lo llevan implícito. Resolverlo da cobertura del 100 % en los 34 cortes trimestrales y evita el cruce por nombre, que fallaba con acentos y alias." },
          { title: "Warehouse dimensional con dbt", body: "Esquema estrella con hechos por vintage sobre DuckDB: dimensiones de departamento, municipio, periodo y variable; la tabla de inclusión en formato largo por bloque de producto, con pruebas que comparan el total departamental contra la suma de sus municipios." },
          { title: "Frecuencia anual, dos paneles", body: "El PIB subnacional es anual: ningún valor anual se repite en cuatro trimestres. El panel departamental cubre 2018 a 2025 y el municipal 2018 a 2024, con el valor agregado municipal del DANE como medida de actividad." },
          { title: "Batería contra la correlación espuria", body: "Efectos fijos de entidad y tiempo como base, más dependencia transversal, efectos correlacionados comunes, placebo por permutación, shift-share con exposición inicial, estudio de eventos y dependencia espacial. Cada cifra publicada traza a una prueba." },
        ],
      },
      result: {
        label: "Resultados",
        headline: "Todavía no hay, y decirlo es parte del método.",
        stat: "Fase 3",
        body: "Publicar una estimación exige antes un dato que la sostenga: las fuentes descargadas y verificadas, las claves geográficas resueltas y el índice construido con pesos congelados. Eso es lo que está hecho. Cuando la estimación llegue se publicará con su especificación, su N, sus clústeres y su prueba, sea cual sea el signo. Es el mismo criterio con el que el pipeline de mercado publicó que solo una de cada ocho estrategias ganadoras sobrevivió fuera de muestra.",
      },
      status: {
        label: "Qué hay y qué llega",
        title: "El proyecto se publica por fases, con su bitácora",
        items: [
          "Hecho: las diecinueve fuentes descargadas con manifiesto, los anexos del DANE y el mapa nacional convertidos a tablas limpias, el warehouse en dbt hasta la tabla larga de inclusión financiera, el sitio y la integración continua.",
          "En curso: el mapa de cada columna a su variable, los hechos anuales y los dos paneles.",
          "Después: el índice por dimensiones, el atlas interactivo y las estimaciones con su batería de pruebas.",
          "Todo el proceso queda en una bitácora pública de errores y aciertos, con la causa raíz y la regla que evita repetir cada uno.",
        ],
      },
      repoCta: "Ver el repositorio",
      siteCta: "Ver el sitio del proyecto",
      backCta: "Volver al inicio",
    },
    track: {
      title: "Trayectoria",
    ...
    cv: {
      ...
      research: [
        {
          name: "Inclusión financiera y crecimiento regional en Colombia",
          role: "Proyecto propio — nace de mi trabajo de grado, Maestría en Economía, Javeriana",
  ...
  en: {
      ...
      also: {
        ...
        rows: [
          ...
          },
          {
            ...
            status: "research",
            statusText: "BUILDING",
            note: "Nineteen public sources (2005–2026) in a dimensional warehouse on dbt and DuckDB, every series resolved to municipal codes. On top: a financial-inclusion index by dimension, annual panels at department and municipality level, and an atlas. It grows out of my master's thesis and rebuilds everything from the sources.",
            href: "/research/fintech-inclusion",
          },
          {
    ...
    thesis: {
      ...
      metaDesc: "Nineteen Colombian public sources (2005–2026) in a dimensional warehouse on dbt and DuckDB, a financial-inclusion index by dimension, and annual panels at department and municipality level.",
      kicker: "Research · open data",
      pill: "BUILDING",
      title: "Financial inclusion and regional growth in Colombia",
      subtitle: "An open warehouse of public sources, an index by dimension and two annual panels. It grows out of my master's thesis at the Javeriana and rebuilds everything from the sources.",
      degree: "Origin: M.Sc. in Economics · Pontificia Universidad Javeriana",
      timeline: "Phases 0 and 1 are in the repository · the index and the estimates land in phases 2 and 3",
      figures: [
        { value: "19", label: "public sources with a manifest and sha256", note: "financial supervisor, statistics office, ICT and education ministries, national map", href: `${THESIS_REPO}#data` },
        { value: "2005–2026", label: "of coverage once the series are rebuilt", note: "GDP from 2005; financial inclusion from 2017", href: `${THESIS_REPO}#data` },
        { value: "1,121", label: "municipalities with resolved geographic keys", note: "100% coverage across the 34 quarterly cuts", href: `${THESIS_SITE}/datos/crosswalk.html` },
        { value: "6.9M", label: "rows downloaded and versioned", note: "partitioned by year in Parquet", href: `${THESIS_SITE}/datos/fuentes.html` },
      ] as Metric[],
      abstract: {
        label: "Abstract",
        body: "Does financial inclusion predict the economic growth of Colombia's departments and municipalities, once you take out the national trends that move all of them at once? My master's thesis asked that with a four-year department panel. This project rebuilds it end to end: it downloads the nineteen public sources with a verifiable manifest, resolves every series to the municipal code, models them as a star schema with vintages on dbt and DuckDB, and builds a two-stage financial-inclusion index with frozen, published weights. On top go two annual panels, department and municipality, with an explicit battery against spurious correlation. Results are published when they exist, together with the code that produced them.",
      },
      method: {
        label: "How it is built",
        title: "Data first, then the index, estimation last",
        items: [
          { title: "Acquisition with a manifest", body: "A purpose-built downloader pages the open-data APIs, verifies the row count against the source, types every column from the portal's metadata and writes Parquet partitioned by year. Each pull records the source date, row count and sha256 in a manifest the site publishes." },
          { title: "Geographic keys resolved", body: "The financial supervisor's tables never declare the municipal code, yet they carry it implicitly. Resolving it gives 100% coverage across the 34 quarterly cuts and avoids name matching, which broke on accents and aliases." },
          { title: "Dimensional warehouse with dbt", body: "A star schema with vintage-aware facts on DuckDB: department, municipality, period and variable dimensions; the inclusion table in long form by product block, with tests that reconcile each department total against the sum of its municipalities." },
          { title: "Annual frequency, two panels", body: "Subnational GDP is annual, so no annual value is ever repeated across four quarters. The department panel covers 2018 to 2025 and the municipal one 2018 to 2024, using the statistics office's municipal value added as the activity measure." },
          { title: "A battery against spurious correlation", body: "Two-way fixed effects as the baseline, plus cross-sectional dependence, common correlated effects, permutation placebos, shift-share exposure, an event study and spatial dependence. Every published figure traces back to a test." },
        ],
      },
      result: {
        label: "Results",
        headline: "There are none yet, and saying so is part of the method.",
        stat: "Phase 3",
        body: "Publishing an estimate requires data that can carry it: the sources downloaded and verified, the geographic keys resolved, the index built with frozen weights. That is what is done. When the estimate arrives it will be published with its specification, its N, its clusters and its test, whatever the sign. It is the criterion the market pipeline applied when it reported that only one in eight winning strategies survived out of sample.",
      },
      status: {
        label: "What is there and what is coming",
        title: "The project ships in phases, with its logbook",
        items: [
          "Done: the nineteen sources downloaded with a manifest, the statistics office's annexes and the national map turned into clean tables, the dbt warehouse up to the long financial-inclusion table, the site and continuous integration.",
          "In progress: the column-to-variable map, the annual facts and the two panels.",
          "Next: the index by dimension, the interactive atlas and the estimates with their battery of tests.",
          "The whole process is logged in public: every mistake and every win with its root cause and the rule that keeps it from happening again.",
        ],
      },
      repoCta: "See the repository",
      siteCta: "See the project site",
      backCta: "Back to home",
    },
    track: {
      title: "Track record",
    ...
    cv: {
      ...
      research: [
        {
          name: "Financial inclusion and regional growth in Colombia",
          role: "Own project — grown out of my master's thesis, M.Sc. in Economics, Javeriana",
