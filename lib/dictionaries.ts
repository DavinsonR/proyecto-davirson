...
export const dictionaries = {
  ...
  es: {
    ...
    sistema: {
      ...
      modules: [
        ...
        },
        {
          ...
          progress: 45,
          desc: "Pipeline de datos + backtester: 45 activos, 1.347 variantes de estrategia, validación fuera de muestra. Resultados en vivo.",
        },
        {
          name: "HISTORIA",
    ...
    featured: {
      ...
      windowTitle: "market-data-medallion / daily_flow — estado: LIVE",
      projectTitle: "Simulador de Trading Algorítmico",
      stack: "python · postgresql · dbt · 45 activos · 55k velas · actualización diaria",
      body: "Un pipeline de datos completo que evalúa 1.347 variantes de estrategia contra 4 años de datos reales, con comisiones, slippage y validación fuera de muestra. El hallazgo: el 88,5% de las estrategias \"ganadoras\" eran ilusiones del backtest. Los resultados —incluidos los malos— están publicados en vivo.",
      link: "explorar el laboratorio completo →",
    ...
    tradingSim: {
      metaTitle: "Trading Sim — 1.347 estrategias contra la realidad",
      metaDesc:
        "1.347 variantes de estrategia evaluadas sobre 45 activos con comisiones, slippage y validación fuera de muestra. El 88,5% de las ganadoras eran ilusiones del backtest.",
      kicker: "// laboratorio · trading_sim",
      title: "1.347 estrategias entraron al laboratorio. Sobrevivieron 40.",
      intro:
      ...
      method: {
        ...
        items: [
          ...
          },
          {
            ...
            body: "Cada variante se entrena en el 70% de la historia y se juzga en el 30% restante, que nunca influyó en su selección. Con 1.347 variantes, sin ventana ciega el resultado sería data dredging.",
          },
          {
  ...
  en: {
    ...
    sistema: {
      ...
      modules: [
        ...
        },
        {
          ...
          status: "building" as Status,
          progress: 45,
          desc: "Data pipeline + backtester: 45 assets, 1,347 strategy variants, out-of-sample validation. Live results.",
        },
        {
          name: "STORY",
          status: "research" as Status,
    ...
    featured: {
      ...
      windowTitle: "market-data-medallion / daily_flow — status: LIVE",
      projectTitle: "Algorithmic Trading Simulator",
      stack: "python · postgresql · dbt · 45 assets · 55k candles · daily refresh",
      body: "A full data pipeline that evaluates 1,347 strategy variants against 4 years of real data, with fees, slippage and out-of-sample validation. The finding: 88.5% of the \"winning\" strategies were backtest illusions. The results — including the bad ones — are published live.",
      link: "explore the full lab →",
      chartLabel: "EQUITY_CURVE.demo",
    ...
    tradingSim: {
      metaTitle: "Trading Sim — 1,347 strategies vs. reality",
      metaDesc:
        "1,347 strategy variants evaluated across 45 assets with fees, slippage and out-of-sample validation. 88.5% of the winners were backtest illusions.",
      kicker: "// lab · trading_sim",
      title: "1,347 strategies entered the lab. 40 survived.",
      intro:
      ...
      method: {
        ...
        items: [
          ...
          },
          {
            ...
            body: "Every variant trains on 70% of history and is judged on the remaining 30%, which never influenced its selection. With 1,347 variants, skipping the blind window would be data dredging.",
          },
          {
