...
export const dictionaries = {
  ...
  es: {
    ...
    thesis: {
      ...
      metaDesc: "Diecinueve fuentes públicas colombianas en un warehouse dimensional con dbt y DuckDB, un índice de inclusión financiera por dimensiones, dos paneles anuales y un atlas interactivo de los 1.123 municipios.",
      kicker: "Investigación · datos abiertos",
      pill: "EN CONSTRUCCIÓN",
      title: "Inclusión financiera y crecimiento regional en Colombia",
      subtitle: "Un warehouse abierto de fuentes públicas, un índice por dimensiones, dos paneles anuales y un atlas de los 1.123 municipios. Nace de mi trabajo de grado en la Javeriana y rehace todo desde las fuentes.",
      degree: "Origen: Maestría en Economía · Pontificia Universidad Javeriana",
      timeline: "Warehouse, índice y atlas publicados · la econometría es lo que falta",
      nav: [
      ...
      data: {
        ...
        items: [
          ...
          { title: "Claves geográficas resueltas", body: "Las tablas de la Superintendencia no declaran el código DIVIPOLA, pero lo llevan implícito en la columna de renglón. Resolverlo da cobertura del 100 % en los 34 cortes trimestrales y evita el cruce por nombre, que fallaba con acentos y alias." },
      ...
      method: {
        ...
        items: [
          ...
          { title: "El PCA se descartó midiéndolo", body: "La medida de adecuación muestral da 0,314 en acceso y 0,404 en uso, por debajo del umbral de 0,5 que hace falta para factorizar. Forzarlo producía pesos implícitos negativos en microcrédito, el mismo defecto que la auditoría del trabajo de grado encontró." },
      ...
      diagnostics: {
        label: "Diagnósticos",
        title: "Qué falló en el trabajo de grado, y qué se corrigió",
        intro: "El trabajo de grado está calificado y aprobado. Auditarlo celda a celda fue el punto de partida de este proyecto, y los hallazgos se publican porque son la razón de rehacerlo.",
        rows: [
          { finding: "El crecimiento no variaba dentro del panel", detail: "El panel trimestral repetía el valor anual en cuatro trimestres: el 64,3 % de las diferencias eran exactamente cero. El nuevo panel es anual de verdad y ninguna de sus 231 observaciones de crecimiento se repite." },
          { finding: "La correlación era de dos tendencias nacionales", detail: "Con efectos fijos de entidad el coeficiente iba de +21 a +58; añadiendo efectos de tiempo caía a +0,36 con p = 0,95. Lo que la regresión veía era 2020 y 2021, no inclusión financiera." },
          { finding: "El panel contaba el doble", detail: "Reconstruir las columnas desde la fuente mostró que el panel original sumaba dos veces el mismo agregado. La comparación queda publicada, columna por columna." },
          { finding: "El índice tenía un peso negativo", detail: "El PCA sobre las variables disponibles asignaba peso negativo al microcrédito: más microcrédito, menos inclusión. Por eso ahora el supuesto se mide antes de elegir el método." },
        ],
      },
      log: {
        label: "Bitácora y decisiones",
        title: "Cuarenta y seis errores y dieciséis aciertos, con su causa raíz",
        body: "Cada error del proceso queda escrito con lo que pasó, la causa raíz, la regla que evita repetirlo y el archivo donde vive la prueba. Las decisiones de valor —frecuencia anual, esquema estrella, método del índice, licencias— van a un ADR antes del código, no después. No es documentación de adorno: es el mecanismo que impide que el proyecto repita los defectos que la auditoría encontró.",
        examples: [
          "El mapa salía como un rectángulo de color porque TopoJSON espera los anillos en sentido horario, al revés que la norma de GeoJSON. Se detectó midiendo el área esférica contra la de Colombia, no mirando la pantalla.",
          "El análisis factorial se descartó midiendo su supuesto, y de ahí salió una regla: antes de elegir un método se mide lo que ese método necesita.",
          "Ninguna capital se rotulaba en el mapa porque un booleano viajaba como texto. Ahora una prueba comprueba el tipo de cada dato publicado.",
        ],
      },
      reproduce: {
        label: "Reproducir",
        ...
        steps: [
          ...
          { cmd: "make check", body: "Ruff, 78 pruebas de Python, 250 modelos y pruebas de dbt sobre DuckDB, y el render del sitio. Sale en cero o no hay commit." },
      ...
      status: {
        ...
        items: [
          "Hecho: las diecinueve fuentes con manifiesto, el warehouse completo en dbt, el índice por dimensiones con sus pesos publicados, los dos paneles anuales y este atlas.",
          "En curso: la econometría —efectos fijos de entidad y tiempo, dependencia transversal, efectos correlacionados comunes, placebo por permutación, shift-share, estudio de eventos y dependencia espacial.",
          "Después: el anexo de desagregación temporal y el manuscrito.",
          "Expectativa honesta: el resultado nulo puede sobrevivir a la batería entera. Si sobrevive, se publica igual.",
        ],
      },
  ...
  en: {
    ...
    thesis: {
      ...
      metaDesc: "Nineteen Colombian public sources in a dimensional warehouse on dbt and DuckDB, a financial-inclusion index by dimension, two annual panels and an interactive atlas of all 1,123 municipalities.",
      kicker: "Research · open data",
      pill: "BUILDING",
      title: "Financial inclusion and regional growth in Colombia",
      subtitle: "An open warehouse of public sources, an index by dimension, two annual panels and an atlas of all 1,123 municipalities. It grows out of my master's thesis at the Javeriana and rebuilds everything from the sources.",
      degree: "Origin: M.Sc. in Economics · Pontificia Universidad Javeriana",
      timeline: "Warehouse, index and atlas published · the econometrics is what is missing",
      nav: [
        { id: "resumen", label: "Abstract" },
        { id: "datos", label: "Data" },
        { id: "metodo", label: "Index" },
        { id: "atlas", label: "Atlas" },
        { id: "diagnosticos", label: "Diagnostics" },
      ...
      data: {
        ...
        items: [
          ...
          { title: "Geographic keys resolved", body: "The financial supervisor's tables never declare the municipal code, yet they carry it implicitly in the row column. Resolving it gives 100% coverage across the 34 quarterly cuts and avoids name matching, which broke on accents and aliases." },
      ...
      method: {
        ...
        items: [
          ...
          { title: "PCA was ruled out by measuring it", body: "Sampling adequacy comes to 0.314 for access and 0.404 for use, below the 0.5 a factor model needs. Forcing it produced negative implicit weights on microcredit — the same defect the thesis audit found." },
      ...
      diagnostics: {
        label: "Diagnostics",
        title: "What failed in the thesis, and what was fixed",
        intro: "The thesis is marked and approved. Auditing it cell by cell was the starting point of this project, and the findings are published because they are the reason to rebuild it.",
        rows: [
          { finding: "Growth did not vary within the panel", detail: "The quarterly panel repeated the annual value across four quarters: 64.3% of the differences were exactly zero. The new panel is genuinely annual and none of its 231 growth observations repeats." },
          { finding: "The correlation was two national trends", detail: "With entity fixed effects the coefficient ran from +21 to +58; adding time effects dropped it to +0.36 with p = 0.95. What the regression saw was 2020 and 2021, not financial inclusion." },
          { finding: "The panel double-counted", detail: "Rebuilding the columns from the source showed the original panel adding the same aggregate twice. The comparison is published, column by column." },
          { finding: "The index carried a negative weight", detail: "PCA over the available variables gave microcredit a negative weight: more microcredit, less inclusion. That is why the assumption is now measured before the method is chosen." },
        ],
      },
      log: {
        label: "Logbook and decisions",
        title: "Forty-six mistakes and sixteen wins, each with its root cause",
        body: "Every mistake in the process is written down with what happened, the root cause, the rule that prevents a repeat and the file where the proof lives. Decisions of substance — annual frequency, star schema, index method, licences — go into a decision record before the code, not after. This is not decorative documentation: it is the mechanism that keeps the project from repeating the defects the audit found.",
        examples: [
          "The map rendered as a coloured rectangle because TopoJSON expects rings wound clockwise, the opposite of the GeoJSON standard. It was caught by measuring spherical area against Colombia's, not by looking at the screen.",
          "Factor analysis was ruled out by measuring its assumption, and a rule came out of it: before choosing a method, measure what that method needs.",
          "No capital was ever labelled on the map because a boolean travelled as text. A test now checks the type of every published field.",
        ],
      },
      reproduce: {
        label: "Reproduce",
        ...
        steps: [
          ...
          { cmd: "make check", body: "Ruff, 78 Python tests, 250 dbt models and tests on DuckDB, and the site render. It exits zero or there is no commit." },
      ...
      status: {
        ...
        items: [
          "Done: the nineteen sources with a manifest, the full dbt warehouse, the index by dimension with its published weights, the two annual panels and this atlas.",
          "In progress: the econometrics — entity and time fixed effects, cross-sectional dependence, common correlated effects, permutation placebos, shift-share, an event study and spatial dependence.",
          "Next: the temporal disaggregation annex and the manuscript.",
          "Honest expectation: the null result may survive the whole battery. If it does, it gets published all the same.",
        ],
      },
